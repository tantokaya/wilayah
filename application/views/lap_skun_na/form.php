...
$(document).ready(function(){
	...
	$("#cari").click(function(){
		...
		if(jml_pilih.length == 0){
		 ...
		 $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/lap_skun_na/lihat",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>/lap_skun_na/cetak/'+string);
...
<tr>    
    ...
    <td width="5"></td>
    <td><input type="text" name="nik" id="nik" size="16" maxlength="16" disabled /></td>
</tr>
</table>
</fieldset>
...
<tr>
	...
	<a href="<?php echo base_url();?>index.php/lap_skun_na">
