...
<table class="grid" width="100%">
	<tr>
    	<th width="5%">No</th>
        <th width="8%">Kode SKTOT</th>
		<th width="15%">Tanggal</th>
        <th width="15%">Nama Ayah</th>
        <th width="15%">Nama Ibu</th>
		<th width="15%">Nama Anak</th>
		<th width="15%">Tempat & Tanggal<br>Lahir Anak</th>
		<th width="*%">Jenis Kelamin<br>Anak</th>
    </tr>        
<?php
}
function myfooter(){	
	...
	$tgl2 = $this->app_model->tgl_indo($r['tgl_lahir3']);
	if(($no%15) == 1){
   	if($no > 1){
        myfooter();
    ...
    <tr>
		...
		<td align="center"><?php echo $r['sktot_nama1'].'<br>'.$r['nik1'];?></td>
        <td align="center"><?php echo $r['sktot_nama2'].'<br>'.$r['nik2'];?></td>
		<td align="center"><?php echo $r['sktot_nama3'].'<br>'.$r['nik3'];?></td>
		<td align="center"><?php echo $r['tmp_lahir3'].'<br>'.$tgl2;?></td>
		<td align="center"><?php echo $r['jk3'];?></td>
    </tr>
    <?php
	$no++;
	}
