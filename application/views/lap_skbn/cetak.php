...
<table class="grid" width="100%">
	<tr>
    	<th width="5%">No</th>
        <th width="10%">Kode SKBN</th>
		<th width="10%">Tanggal</th>
		<th width="15%">NIK</th>
        <th width="15%">Nama Lengkap</th>
        <th width="15%">Ejaan/Huruf yang Salah</th>
        <th width="15%">Ejaan/Huruf yang Benar</th>
...
function myfooter(){	
    ...
    <tr>
		...
		<td align="justify">&nbsp;<?php echo $r['skbn_nama'];?></td>
        <td align="justify">&nbsp;<?php echo $r['maksud1'];?></td>
        <td align="justify">&nbsp;<?php echo $r['maksud2'];?></td>
		 <td align="justify">&nbsp;<?php echo $r['maksud3'];?></td>
    </tr>
    <?php
	$no++;
	}
