...
<form name="form" method="post" action="<?php echo base_url();?>index.php/skrt">
...
<?php
	if($data->num_rows()>0){
	    ...
	    <td align="center" width="100" ><?php echo $db['nomor']; ?></td>
            ...
            <td align="center" width="100" ><?php echo $db['skrt_nama']; ?></td>
			<td align="center" width="80">
            <?php
			if($this->session->userdata('level')=='01'){
			?>
            <a href="<?php echo base_url();?>index.php/skrt/edit/<?php echo $db['nmr_surat'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>&nbsp;&nbsp;| &nbsp;&nbsp;
            <a href="<?php echo base_url();?>index.php/skrt/hapus/<?php echo $db['nmr_surat'];?>"
