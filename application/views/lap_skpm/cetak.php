...
<table class="grid" width="100%">
	<tr>
    	<th width="5%">No</th>
        <th width="8%">Kode SKPM</th>
		<th width="15%">Tanggal</th>
		<th width="15%">NIK Calon Suami</th>
        <th width="15%">Nama Calon Suami</th>
        <th width="15%">NIK Calon Istri</th>
        <th width="15%">Nama Calon Istri</th>
    </tr>        
<?php
}
function myfooter(){	
    ...
    <tr>
		...
		<td align="center"><?php echo $r['skpm_nama1'];?></td>
        <td align="center"><?php echo $r['nik2'];?></td>
        <td align="center"><?php echo $r['skpm_nama2'];?></td>
    </tr>
    <?php
	$no++;
	}
