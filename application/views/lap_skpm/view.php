...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" width="15%"><?php echo $db['skpm_nama1']; ?></td>
            <td align="center" width="15%" ><?php echo $db['nik2']; ?></td>
			<td align="center" width="15%" ><?php echo $db['skpm_nama2']; ?></td>
        </tr>
    <?php
		$no++;
		}
