...
function myfooter(){	
	...
	$tmp_lahir = $this->load->app_model->tgl_indo($r['bio_tgl_lahir']);
	if(($no%25) == 1){
   	if($no > 1){
        myfooter();
    ...
    <tr>
        ...
        <td >&nbsp;<?php echo $r['bio_nama'];?></td>
        <td align="center"><?php echo $r['bio_tmp_lahir'];?></td>
        <td align="center"><?php echo $tmp_lahir;?></td>
        <td align="left">&nbsp;<?php echo $r['bio_alamat'];?></td>
		<td align="center"><?php echo $r['bio_kew'];?></td>
        <td align="center">
		<?php if($r['bio_jk']=='1'){ echo 'L';}else{echo 'P';} ?>
		</td>
...
<div class="page" align="center">Hal - <?php echo $page;?> <br/></div>