...
<table class="grid" width="100%">
	<tr>
    	<th width="5%">No</th>
        <th width="10%">Kode SKB</th>
		<th width="12.5%">Tanggal</th>
		<th width="12.5%">NIK</th>
        <th width="15%">Nama Lengkap</th>
		<th width="20%">Alamat</th>
		<th width="12.5%">Maksud Bepergian</th>
        <th width="12.5%">Tujuan Bepergian</th>
    </tr>        
<?php
}
function myfooter(){	
    ...
    <tr>
		...
		<td align="justify">&nbsp;<?php echo $r['skb_nama'];?></td>
		 <td align="justify">&nbsp;<?php echo $r['alamat'];?></td>
        <td align="justify">&nbsp;<?php echo $r['maksud'];?></td>
        <td align="justify">&nbsp;<?php echo $r['tujuan'];?></td>
    </tr>
    <?php
	$no++;
	}
