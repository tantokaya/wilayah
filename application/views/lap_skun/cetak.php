...
<table class="grid" width="100%">
	<tr>
        ...
        <th width="8%" rowspan="2">Kode SKUN</th>
		<th width="15%" rowspan="2">Tanggal</th>
		<th width="15%" rowspan="2">NIK</th>
        <th width="15%" rowspan="2">Nama Lengkap</th>
        <th width="15%" rowspan="2">Bin/Binti</th>
		<th width="*%" colspan="2">Status Perkawinan</th>
    </tr>      
	<tr>
	    <th width="*%">Keterangan</th>
		<th width="*%">Nama Suami/Isti Terdahulu</th>
	</tr>
<?php
}
function myfooter(){	
    ...
    <tr>
		...
		<td align="justify">&nbsp;<?php echo $r['skun_nama'];?></td>
        <td align="justify">&nbsp;<?php echo $r['bin_binti'];?></td>
        <td align="justify">&nbsp;<?php echo $r['status1'];?></td>
		 <td align="justify">&nbsp;<?php echo $r['status2'];?></td>
    </tr>
    <?php
	$no++;
	}
