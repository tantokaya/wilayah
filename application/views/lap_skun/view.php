...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" width="15%"><?php echo $db['skun_nama']; ?></td>
			<td align="center" width="*%"><?php echo $db['tmp_lahir'].'<br>'.$tgl2; ?></td>
			<td align="center" width="15%"><?php echo $db['bin_binti']; ?></td>
            <td align="center" width="15%" ><?php echo $db['alamat']; ?></td>
        </tr>
    <?php
		$no++;
		}
