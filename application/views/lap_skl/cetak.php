...
function myfooter(){	
    ...
    <tr>
		...
		<td align="center">&nbsp;<?php echo $r['skl_nama1'].'<br>'.$r['nik1'];?></td>
        <td align="center">&nbsp;<?php echo $r['skl_nama2'].'<br>'.$r['nik2'];?></td>
		<td align="center">&nbsp;<?php echo $r['skl_nama3'];?></td>
