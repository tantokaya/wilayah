...
<table class="grid" width="100%">
	<tr>
    	<th width="5%">No</th>
        <th width="10%">Kode SKIR</th>
		<th width="10%">Tanggal</th>
		<th width="10%">NIK</th>
        <th width="15%">Nama Lengkap</th>
		<th width="20%">Alamat</th>
		<th width="10%">Tanggal Keramaian</th>
		<th width="15%">Waktu Keramaian</th>
    </tr>        
<?php
}
function myfooter(){	
	...
	$tgl_ramai = $this->app_model->tgl_indo($r['tgl_ramai']);
	if(($no%25) == 1){
   	if($no > 1){
        myfooter();
    ...
    <tr>
		...
		<td align="justify">&nbsp;<?php echo $r['skir_nama'];?></td>
		<td align="justify">&nbsp;<?php echo $r['alamat'];?></td>
		<td align="center"><?php echo $tgl_ramai;?></td>
		<td align="justify">&nbsp;<?php echo $r['wkt_ramai'];?></td>
    <?php
	$no++;
	}
myfooter();	
