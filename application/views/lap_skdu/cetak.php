...
<table class="grid" width="100%">
	<tr>
    	<th width="5%">No</th>
        <th width="10%">Kode SKDU</th>
		<th width="10%">Tanggal</th>
		<th width="10%">Tanggal Berlaku</th>
		<th width="15%">NIK</th>
        <th width="15%">Nama Lengkap</th>
        <th width="12.5%">Perusahaan</th>
        <th width="12.5%">Bidang Usaha</th>
    </tr>        
<?php
}
function myfooter(){	
	...
	$tgl2 = $this->app_model->tgl_indo($r['tgl_berlaku']);
	if(($no%25) == 1){
   	if($no > 1){
        myfooter();
    ...
    <tr>
		...
		<td align="justify"><?php echo $r['skdu_nama'];?></td>
        <td align="justify"><?php echo $r['perusahaan'];?></td>
        <td align="justify"><?php echo $r['bid_usaha'];?></td>
    </tr>
    <?php
	$no++;
	}
