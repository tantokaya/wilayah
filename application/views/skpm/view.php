...
<form name="form" method="post" action="<?php echo base_url();?>index.php/skpm">
Tanggal <input type="text" name="cari_tgl" id="cari_tgl" size="15" />
Cari No SK / NIK / Nama : <input type="text" name="txt_cari" id="txt_cari" size="50" />
...
<?php
	if($data->num_rows()>0){
	    ...
	    <td align="center" width="100" ><?php echo $db['nomor']; ?></td>
            ...
            <td align="center" width="100" ><?php echo $db['skpm_nama1']; ?></td>
			<td align="center" width="100" ><?php echo $db['nik2']; ?></td>
			<td align="center" width="100" ><?php echo $db['skpm_nama2']; ?></td>
			<td align="center" width="80">
            <?php
			if($this->session->userdata('level')=='01'){
			?>
            <a href="<?php echo base_url();?>index.php/skpm/edit/<?php echo $db['nmr_surat'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>&nbsp;&nbsp;| &nbsp;&nbsp;
            <a href="<?php echo base_url();?>index.php/skpm/hapus/<?php echo $db['nmr_surat'];?>"
