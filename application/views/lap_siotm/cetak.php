...
function myfooter(){	
    ...
    <tr>
		...
		<td align="center">&nbsp;<?php echo $r['siotm_nama1'].'<br>'.$r['nik1'];?></td>
        <td align="center">&nbsp;<?php echo $r['siotm_nama2'].'<br>'.$r['nik2'];?></td>
        <td align="center">&nbsp;<?php echo $r['siotm_nama3'].'<br>'.$r['nik3'];?></td>
		<td align="center">&nbsp;<?php echo $r['siotm_nama4'].'<br>'.$r['nik4'];?></td>
    </tr>
    <?php
	$no++;
	}
