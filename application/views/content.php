...
<br />
<?php 
if($this->session->userdata('level')=='01' OR '02')
...
<table class="list" width="100%">
    ...
    <tr>
    	<td class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/biodata"><img src="<?php echo base_url();?>asset/images/id.png" /><br />
        <b>Data Penduduk</b></a>
        </td>
        <td  class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/sk"><img src="<?php echo base_url();?>asset/images/surat_keputusan.png" /><br />
        <b>Pembuatan Surat Keterangan</b></a>
        </td>
	<td class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/suratketerangan"><img src="<?php echo base_url();?>asset/images/laporan_surat.png" /><br />
        <b>Laporan Surat Keterangan</b></a>
        </td>
        <td class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/lap_penduduk"><img src="<?php echo base_url();?>asset/images/distributor-report.png" /><br />
        <b>Laporan Data Penduduk</b></a>
        </td>
	</tr>  
    <tr>
    	 <td  class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/grafik_penduduk"><img src="<?php echo base_url();?>asset/images/pie_chart.png" /><br />
        <b>Grafik Data Penduduk</b></a>
        </td>
        <td  class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/grafik_sk"><img src="<?php echo base_url();?>asset/images/pie_chart.png" /><br />
        <b>Grafik Surat Keterangan</b></a>
        </td>
		<td class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/grafik_suratketerangan"><img src="<?php echo base_url();?>asset/images/grafik_bars.png"/><br />
        <b>Grafik Per-Surat Keterangan</b></a>
        </td>
        <td class="btn" align="center" width="20%"><a href="<?php echo base_url();?>index.php/tentang"><img src="<?php echo base_url();?>asset/images/keuangan.png" /><br />
        <b>Tentang Aplikasi</b></a>
        </td>
    </tr>
    <tr>
	<td colspan="4">
