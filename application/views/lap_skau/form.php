...
$(document).ready(function(){
	...
	$("#cari").click(function(){
		...
		if(jml_pilih.length == 0){
		 ...
		 $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/lap_skau/lihat",
			data	: string,
			cache	: false,
	...
	$("#cetak").click(function(){
		...
		window.open('<?php echo site_url();?>/lap_skau/cetak/'+string);
...
<tr>    
    ...
    <td width="5"></td>
    <td><input type="text" name="nik" id="nik" size="16" maxlength="16" disabled /><span style="font-weight:100; margin-left:20px;">Masukkan Kode NIK Anak / Ayah / Ibu</span></td>
</tr>
</table>
</fieldset>
...
<tr>
	...
	<a href="<?php echo base_url();?>index.php/lap_skau">
