...
function myfooter(){	
	...
	$tgl2 = $this->app_model->tgl_indo($r['tgl_lahir1']);
	if(($no%25) == 1){
   	if($no > 1){
        myfooter();
    ...
    <tr>
		...
		<td align="center">&nbsp;<?php echo $r['skau_nama1'].'<br>'.$r['nik1'];?></td>
		<td align="center"><?php echo $r['tmp_lahir1'].'<br>'.$tgl2;?></td>
		<td align="center"><?php echo $r['jk1'];?></td>
        <td align="center">&nbsp;<?php echo $r['skau_nama2'].'<br>'.$r['nik2'];?></td>
		 <td align="center">&nbsp;<?php echo $r['skau_nama3'].'<br>'.$r['nik3'];?></td>
    </tr>
    <?php
	$no++;
	}
