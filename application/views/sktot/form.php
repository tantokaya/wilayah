...
///////////// CARI ANAK KANDUNG ////////////	
	...
	var nmr_surat	= $("#nmr_surat").val();
		...
		$.ajax({  
			url:"<?php echo site_url(); ?>/sktot/checkdata",  
			data:"nmr_surat="+nmr_surat, 
			type:"POST", 
			dataType : "json",
			success:function(data){  
			if(data.success){  
				window.open('<?php echo site_url();?>/cetak/sktot_pdf/'+nmr_surat);
			}else{  
...
<tr>    
    ...
    <tr>    
        <td>Nama Lengkap</td>
        <td>:</td>
        <td><input type="text" name="sktot_nama1" id="bio_nama"  size="50" class="detail" maxlength="50"  value="<?php echo $sktot_nama1;?>"/></td>
    </tr>
    <tr>    
        <td>Tempat Lahir</td>
        <td>:</td>
    ...
    <tr>    
        <td>Jenis Kelamin</td>
        <td>:</td>
        <!--<td><input type="text" name="jk1" id="bio_jk"  size="10"class="detail" maxlength="10" value="<?php echo $jk1;?>"   /></td>-->
		<td>
    ...
    <tr>    
        ...
        <td>:</td>
        <!--<td><input type="text" name="kew_id1" id="bio_kew"  size="10"class="detail" maxlength="10" value="<?php echo $kew_id1;?>"  /></td>-->
		<td>
...
<tr>    
    ...
    <tr>    
        <td>Nama Lengkap</td>
        <td>:</td>
        <td><input type="text" name="sktot_nama2" id="bio_nama2"  size="50" class="detail" maxlength="50" value="<?php echo $sktot_nama2;?>"/></td>
    </tr>
	<tr>    
        <td>Tempat Lahir</td>
        <td>:</td>
...
<tr>    
    ...
    <tr>    
        <td>Nama Lengkap</td>
        <td>:</td>
        <td><input type="text" name="sktot_nama3" id="bio_nama3"  size="50" class="detail" maxlength="50" value="<?php echo $sktot_nama3;?>"/></td>
    </tr>
	<tr>    
        <td>Tempat Lahir</td>
        <td>:</td>
