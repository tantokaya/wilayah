...
function myfooter(){	
	...
	$tgl2 = $this->app_model->tgl_indo($r['tgl_lahir']);
	if(($no%25) == 1){
   	if($no > 1){
        myfooter();
    ...
    <tr>
		...
		<td align="center"><?php echo $r['no_kk'];?></td>
		<td align="center"><?php echo $r['skdk_nama'];?></td>
		<td align="center"><?php echo $r['tmp_lahir'].'<br>'.$tgl2;?></td>
