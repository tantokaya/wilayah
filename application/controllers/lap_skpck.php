...
class Lap_skpck extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Pengantar Kepolisian
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Pengantar Kepolisian";
			
			$d['content'] = $this->load->view('lap_skpck/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skpck $where";
			...
			$this->load->view('lap_skpck/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skpck/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skpck.php */
/* Location: ./application/controllers/lap_skpck.php */