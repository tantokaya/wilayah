...
class Lap_skbn extends CI_Controller {

	/**
	* @author : Hartanto Kurniawan,S.Kom
	* @keterangan : Controller untuk halaman Laporan Surat Keterangan Beda Nama
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Beda Nama";
			
			$d['content'] = $this->load->view('lap_skbn/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skbn $where";
			...
			$this->load->view('lap_skbn/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skbn/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skbn.php */
/* Location: ./application/controllers/lap_skbn.php */