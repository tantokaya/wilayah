...
class Lap_skbm extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Belum Menikah
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Belum Menikah";
			
			$d['content'] = $this->load->view('lap_skbm/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skbm $where";
			...
			$this->load->view('lap_skbm/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skbm/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skbm.php */
/* Location: ./application/controllers/lap_skbm.php */