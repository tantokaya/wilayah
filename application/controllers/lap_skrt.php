...
class Lap_skrt extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Riwayat Tanah
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Riwayat Tanah";
			
			$d['content'] = $this->load->view('lap_skrt/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skrt $where";
			...
			$this->load->view('lap_skrt/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skrt/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skrt.php */
/* Location: ./application/controllers/lap_skrt.php */