...
class Lap_sktmp extends CI_Controller {

	/**
	* @author : Hartanto Kurniawan,S.Kom
	* @keterangan : Controller untuk Laporan Surat Keterangan Tidak Mampu
	**/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Tidak Mampu";
			
			$d['content'] = $this->load->view('lap_sktmp/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM sktmp $where";
			...
			$this->load->view('lap_sktmp/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_sktmp/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_sktmp.php */
/* Location: ./application/controllers/lap_sktmp.php */