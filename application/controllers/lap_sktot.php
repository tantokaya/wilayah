...
class Lap_sktot extends CI_Controller {

	/**
	* @author : Hartanto Kurniawan,S.Kom
	* @keterangan : Controller untuk halaman Laporan Surat Keterangan Tentang Orang Tua
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Tentang Orang Tua";
			
			$d['content'] = $this->load->view('lap_sktot/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM sktot $where";
			...
			$this->load->view('lap_sktot/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_sktot/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_sktot.php */
/* Location: ./application/controllers/lap_sktot.php */