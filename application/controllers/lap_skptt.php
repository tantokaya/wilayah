...
class Lap_skptt extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Penghasilan Tidak Tetap
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Penghasilan Tidak Tetap";
			
			$d['content'] = $this->load->view('lap_skptt/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skptt $where";
			...
			$this->load->view('lap_skptt/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skptt/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skptt.php */
/* Location: ./application/controllers/lap_skptt.php */