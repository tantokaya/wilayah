...
class Lap_skppsp extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Pengantar Penerbitan SPPT PBB
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Pengantar Penerbitan SPPT PBB";
			
			$d['content'] = $this->load->view('lap_skppsp/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skppsp $where";
			...
			$this->load->view('lap_skppsp/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skppsp/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skppsp.php */
/* Location: ./application/controllers/lap_skppsp.php */