...
class Lap_sktkt extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Tidak Keberatan Tetangga
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Tidak Keberatan Tetangga";
			
			$d['content'] = $this->load->view('lap_sktkt/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM sktkt $where";
			...
			$this->load->view('lap_sktkt/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_sktkt/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_sktkt.php */
/* Location: ./application/controllers/lap_sktkt.php */