...
class Lap_skb extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Bepergian
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Bepergian";
			
			$d['content'] = $this->load->view('lap_skb/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skb $where";
	...
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skb/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skb.php */
/* Location: ./application/controllers/lap_skb.php */