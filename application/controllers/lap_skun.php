...
class Lap_skun extends CI_Controller {
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Untuk Menikah";
			
			$d['content'] = $this->load->view('lap_skun/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skun/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skun/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
