...
class Lap_skir extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Ijin Keramaian
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Ijin Keramaian";
			
			$d['content'] = $this->load->view('lap_skir/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skir $where";
			...
			$this->load->view('lap_skir/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skir/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skir.php */
/* Location: ./application/controllers/lap_skir.php */