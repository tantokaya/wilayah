...
class Lap_sktt extends CI_Controller {

	/**
	* @author : Hartanto Kurniawan,S.Kom
	* @keterangan : Controller untuk Laporan Surat Keterangan Tempat Tinggal
	**/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Tempat Tinggal";
			
			$d['content'] = $this->load->view('lap_sktt/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM sktt $where";
			...
			$this->load->view('lap_sktt/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_sktt/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_sktt.php */
/* Location: ./application/controllers/lap_sktt.php */