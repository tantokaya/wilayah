...
class Lap_skk extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Kematian
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Kematian";
			
			$d['content'] = $this->load->view('lap_skk/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skk $where";
	...
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skk/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skk.php */
/* Location: ./application/controllers/lap_skk.php */