...
class Lap_skjd extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Janda/Duda
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Janda/Duda";
			
			$d['content'] = $this->load->view('lap_skjd/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skjd $where";
			...
			$this->load->view('lap_skjd/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skjd/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skjd.php */
/* Location: ./application/controllers/lap_skjd.php */