...
class Lap_skdu extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Domisili Usaha
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Domisili Usaha";
			
			$d['content'] = $this->load->view('lap_skdu/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skdu/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skdu/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skdu.php */
/* Location: ./application/controllers/lap_skdu.php */