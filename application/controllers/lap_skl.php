...
class Lap_skl extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Kelahiran
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Kelahiran";
			
			$d['content'] = $this->load->view('lap_skl/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skl $where";
	...
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skl/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skl.php */
/* Location: ./application/controllers/lap_skl.php */