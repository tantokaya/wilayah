...
class Lap_skdk extends CI_Controller {

	/**
	* @author : Hartanto Kurniawan,S.Kom
	* @keterangan : Controller untuk halaman Laporan Surat Keterangan Daftar Keluarga
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Daftar Keluarga";
			
			$d['content'] = $this->load->view('lap_skdk/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skdk $where";
			...
			$this->load->view('lap_skdk/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skdk/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skdk.php */
/* Location: ./application/controllers/lap_skdk.php */