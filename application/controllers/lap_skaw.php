...
class Lap_skaw extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Ahli Waris
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Ahli Waris";
			
			$d['content'] = $this->load->view('lap_skaw/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skaw $where";
			...
			$this->load->view('lap_skaw/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skaw/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skaw.php */
/* Location: ./application/controllers/lap_skaw.php */