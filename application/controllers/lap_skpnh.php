...
class Lap_skpnh extends CI_Controller {

	/**
	 * @author : Hartanto Kurniawan,S.Kom
	  * @keterangan : Controller untuk halaman Laporan Surat Keterangan Pengantar Naik Haji
	 **/
	...
	public function index()
	{
		...
		if(!empty($cek)){
			...
			$d['judul']="Laporan Surat Keterangan Pengantar Naik Haji";
			
			$d['content'] = $this->load->view('lap_skpnh/form', $d, true);		
	...
	public function lihat()
	{
		...
		if(!empty($cek)){
			...
			$total = "SELECT COUNT(*) 'tgl_pengajuan' FROM skpnh $where";
			...
			$this->load->view('lap_skpnh/view',$d);
		}else{
			header('location:'.base_url());
		}
	}
	public function cetak()
	{
		...
		if(!empty($cek)){
			...
			$this->load->view('lap_skpnh/cetak',$d);
		}else{
			header('location:'.base_url());
		}
	}
...
/* End of file lap_skpnh.php */
/* Location: ./application/controllers/lap_skpnh.php */